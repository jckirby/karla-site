...
function (a) {
    a.Editable.prototype.refreshImageAlign = function (a) {
        ...
        }), this.enable(), this.hide(), this.hideImageLoader(), this.wrapText(), this.triggerEvent("imageInserted", [this.$element.find("img.fr-just-inserted"), c]), setTimeout(a.proxy(function () {
